...
if (!$authGuard->isTokenValid(CronEnv::read('CRON_GITHUB_TOKEN', ''), $providedToken)) {
...
$result = (new CronCommandChainRunner())->run(
    ['app:update-github-extensions', 'app:build-extension-snapshot'],
    static function (string $commandName) use ($application): array {
        ...
        if ($commandName === 'app:update-github-extensions') {
